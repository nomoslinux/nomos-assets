...
Before making this repository public, every distributable asset must have its
source, author/owner, and licence status recorded in
[PROVENANCE.md](PROVENANCE.md). Assets whose rights are unclear should be
removed or replaced rather than published on assumption.
